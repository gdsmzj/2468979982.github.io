                            ...
                            <div className="relative group">
                                ...
                                <Link href="/blog">
                                    <span
                                        ...
                                        <SocialIcon kind="educate" href="/blog" size="6" noLink />
                                        <span
                                            className="pr-6 text-gray-900 dark:text-gray-100">Read my article</span></span><span
                                        className="pl-6 text-primary-400 transition duration-200 group-hover:text-gray-900 dark:group-hover:text-gray-100">Blog&nbsp;→</span></span>
                                </Link>
                            </div>
                        </div>
                            ...
                            <div className="group relative">
                                ...
                                <Link href="/projects">
                                    <span
                                        className="relative flex items-center divide-x divide-gray-600 rounded-lg bg-white px-7 py-4 leading-none dark:bg-black"><span
                                        className="flex items-center space-x-5">
                                         <SocialIcon kind="chemistry" href="/projects" size="6" noLink />
                                        <span
                                            className="pr-6 text-gray-900 dark:text-gray-100">What I built</span></span><span
                                        className="pl-6 text-amber-400 transition duration-200 group-hover:text-gray-900 dark:group-hover:text-gray-100">Projects&nbsp;→</span></span>
                                </Link>
                            </div>
                        </div>
                        <div className="my-2 grid items-start gap-8">
                            <div className="group relative">
                                ...
                                <Link href="/about">
                                    <span
                                        className="relative flex items-center divide-x divide-gray-600 rounded-lg bg-white px-7 py-4 leading-none dark:bg-black"><span
                                        className="flex items-center space-x-5">
                                        <SocialIcon kind="book" href="/about" size="6" noLink />
                                        <span
                                            className="pr-6 text-gray-900 dark:text-gray-100">About my introduction</span></span><span
                                        className="pl-6 text-indigo-400 transition duration-200 group-hover:text-gray-900 dark:group-hover:text-gray-100">About&nbsp;→</span></span>
                                </Link>
                            </div>
                        </div>
                    </div>
