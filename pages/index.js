      ...
      <div className="fade-in banner flex flex-1 flex-row flex-wrap justify-between px-6 py-10 dark:text-white lg:px-10">
        <div className="flex flex-col justify-center">
          <h1 className="text-3xl font-bold dark:text-white lg:text-5xl">
            你好，我是 {siteMetadata.author}
          </h1>
          <p className="my-2 text-lg lg:my-4 lg:text-2xl">中级软件工程师</p>
                ...
                <Link href="/blog">
                  <span className="relative flex items-center divide-x divide-gray-600 rounded-lg bg-white px-7 py-4 leading-none dark:bg-black">
                    <span className="flex items-center space-x-5">
                      ...
                      <span className="pr-6 text-gray-900 dark:text-gray-100">阅读我的文章</span>
                    </span>
                ...
                <Link href="/projects">
                  <span className="relative flex items-center divide-x divide-gray-600 rounded-lg bg-white px-7 py-4 leading-none dark:bg-black">
                    <span className="flex items-center space-x-5">
                      ...
                      <span className="pr-6 text-gray-900 dark:text-gray-100">我的项目</span>
                    </span>
                ...
                <Link href="/about">
                  <span className="relative flex items-center divide-x divide-gray-600 rounded-lg bg-white px-7 py-4 leading-none dark:bg-black">
                    <span className="flex items-center space-x-5">
                      ...
                      <span className="pr-6 text-gray-900 dark:text-gray-100">关于我的介绍</span>
                    </span>
